 ...
 * @author GLB-214
 */
public class PrettyWomanThread extends Thread {

    KyaBossDaoImpl objKyaBossDaoImpl = null;

    public PrettyWomanThread(KyaBossDaoImpl objKyaBossDaoImpl) {
    ...
    public void categoryPrettyWoman() {
        ...
        try {
            ...
            do {
                ...
                String response = obj.fetchPageSourceWithProxyPOST("http://www.kyaboss.com/wp-admin/admin-ajax.php", urlParameter, "http://www.kyaboss.com/category/pretty-woman", "www.kyaboss.com", "192.158.228.196", "7631", "mongoose", "y7uQAZuLA");
