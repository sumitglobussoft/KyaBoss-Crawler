 ...
 * @author GLB-214
 */
public class BeAManThread extends Thread {

    KyaBossDaoImpl objKyaBossDaoImpl = null;

    public BeAManThread(KyaBossDaoImpl objKyaBossDaoImpl) {
    ...
    public void categoryBeAMan() {
        ...
        try {
            ...
            do {
                ...
                String response = obj.fetchPageSourceWithProxyPOST("http://www.kyaboss.com/wp-admin/admin-ajax.php", urlParameter, "http://www.kyaboss.com/category/be-a-man", "www.kyaboss.com", "192.158.228.196", "7631", "mongoose", "y7uQAZuLA");
