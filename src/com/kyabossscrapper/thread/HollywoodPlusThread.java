 ...
 * @author GLB-214
 */
public class HollywoodPlusThread extends Thread {

    KyaBossDaoImpl objKyaBossDaoImpl = null;

    public HollywoodPlusThread(KyaBossDaoImpl objKyaBossDaoImpl) {
    ...
    public void categoryHollywoodPlus() {
        ...
        try {
            ...
            do {
                ...
                String response = obj.fetchPageSourceWithProxyPOST("http://www.kyaboss.com/wp-admin/admin-ajax.php", urlParameter, "http://www.kyaboss.com/category/hollywood-plus", "www.kyaboss.com", "192.158.228.196", "7631", "mongoose", "y7uQAZuLA");
